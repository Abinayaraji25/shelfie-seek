  ...
  head: () => ({
    meta: [
      ...
      { title: "Smart Library Book Finder" },
      {
        name: "description",
        content:
          "Search your college library, check availability, find the exact rack and shelf, and borrow or return books.",
      },
      { property: "og:title", content: "Smart Library Book Finder" },
      {
        property: "og:description",
        content: "Find any college library book by title, author or keyword — with rack and shelf location.",
      },
